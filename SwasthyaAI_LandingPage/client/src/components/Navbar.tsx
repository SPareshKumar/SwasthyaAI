            ...
            <div className="hidden md:block">
              <div className="flex items-center space-x-8">
                ...
                <div className="relative group">
                  ...
                  <div className="absolute left-0 mt-2 w-48 bg-white rounded-xl shadow-md opacity-0 invisible group-hover:opacity-100 group-hover:visible transition-all duration-300 z-50">
                    <div className="py-2 px-4 glassmorphism rounded-xl">
                      <button
                        onClick={() => window.open("https://indian-diet-guide.onrender.com", "_blank")}
                        className="block py-2 px-4 text-sm text-gray-700 hover:text-primary hover:bg-gray-50 rounded-lg w-full text-left"
                      >
                        Diet
                      </button>
                      <button
        ...
        {isOpen && (
          ...
          >
            <div className="px-4 py-4 space-y-3">
              ...
              >
                Explore
                <ChevronDown className={`h-4 w-4 transition-transform duration-300 ${isExploreOpen ? "rotate-180" : ""}`} />
              </button>
              {isExploreOpen && (
                <motion.div
                  initial={{ opacity: 0, height: 0 }}
